...
experiment_dict = {
    'problem_dict' : {
        'problem': 'maxkcolor',
        'problem_size': np.round(np.logspace(0.5, 2.3, 8)),
        'fixed_problem_size': 100 # use whatever value was used to determine optimal hyperparameters
        },
