'''
current release of mlrose-hiive does not have SyntheticData, so pasting the code here from
    https://github.com/hiive/mlrose/blob/master/mlrose_hiive/samples/synthetic_data.py
